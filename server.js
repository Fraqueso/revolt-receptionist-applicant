      ...
      try {
        ...
        if (error.message && error.message.includes('timeout')) {
          ...
          if (error.code === 'ECONNREFUSED') {
            console.error('⚠️  Connection refused - check if n8n webhook URL is correct and accessible');
            webhookError.details = 'Connection refused - webhook URL may be incorrect';
          }
        }
      }
